...
class RandomAgent(BaseAgent):
    ...
    def act(self, obs, reward=0.0, done=False):
        ...
        adjust_gen_p_action_space.np_random.seed(0)
        adjust_gen_v_action_space.np_random.seed(0)
        adjld_p_action_space.np_random.seed(0)
        stoenergy_p_action_space.np_random.seed(0)
        ...
        # print('total', )
        # print('ld_p', len(obs.ld_p))
        # print('ld_q', len(obs.ld_q))
        # print('adjld_p', len(obs.adjld_p))
        # print('stoenergy_p', len(obs.stoenergy_p))
        # print('ld_name', len(self.settings.ld_name))
        print('flag', obs.flag)
